...
import com.novatech.aquamarine.repository.PollutionReportRepository;
...
public class PollutionReportController {
    ...
    public ResponseEntity<PollutionReport> get(@PathVariable Long id) {
    ...
    public ResponseEntity<PollutionReport> post(@RequestBody @Valid PollutionReport PollutionReport) {
        try {
            return ResponseEntity.ok(repository.save(PollutionReport));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @PutMapping
    @ResponseStatus(CREATED)
    public ResponseEntity<PollutionReport> update(@RequestBody @Valid PollutionReport PollutionReport) {
        verify(PollutionReport.getReportId());
